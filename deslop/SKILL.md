...
Copied from [stephenturner/skill-deslop](https://github.com/stephenturner/skill-deslop)
by Stephen D. Turner (MIT, see [LICENSE](LICENSE)). The extra structure sections
(Negation-Then-Reframe Couplet, Rather-Than Padding, Announced-Count Preamble)
come from the `patch-2` branch of the
[tacolopo fork](https://github.com/tacolopo/skill-deslop/tree/patch-2).

That skill in turn combines two open sources:

- The AI writing tropes catalog from [tropes.fyi](https://tropes.fyi/) by
  [Ossama Hassanein](https://ossama.is), adapted into `references/tropes.md`.
- [stop-slop](https://github.com/hardikpandya/stop-slop) by
  [Hardik Pandya](https://hvpandya.com), the source of the phrase lists,
  structural patterns, before/after examples, scoring rubric, and quick checks.
